...
class SendNotificationReminderBeforeOneDay extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminder:before one day';
     ...
     * @var string
     */
    protected $description = 'Send notification reminder before one day';
