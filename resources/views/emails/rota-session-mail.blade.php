...
@section('email-content')
    ...
    <p style="font-size: 18px; line-height: 25.5px; font-weight: 600; font-family: 'Nunito Sans', sans-serif; color: #464B70; margin-bottom: 27px;">We are writing to inform you about the upcoming session at {{ $rota_session_detail->roomDetail->hospital->hospital_name ?? ''}} scheduled for {{ dateFormat($rota_session_detail->week_day_date,'d-m-Y').'('.$rota_session_detail->time_slot.')'  }}. Please find the important details below:</p>
