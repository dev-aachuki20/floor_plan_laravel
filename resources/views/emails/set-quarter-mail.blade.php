...
@section('email-content')
        ...
        <p style="font-size: 16px; line-height: 25.5px; font-weight: normal; font-family: 'Nunito Sans', sans-serif; color: #000; margin-bottom: 27px;margin-top: 10px;">Please find below the scheduled sessions for hospital rooms</p>
        ...
        <p style="font-size: 16px; line-height: 25.5px; font-weight: normal;color: #000; margin-bottom: 27px; margin-top:27px;">We appreciate your cooperation and understanding. Let’s work together to ensure the best possible care for our patients.</p>
