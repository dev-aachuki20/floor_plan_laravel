...
@section('email-content')
    ...
    <p style="font-size: 16px; line-height: 25.5px; font-weight: normal; font-family: 'Nunito Sans', sans-serif; color: #000; margin-bottom: 27px;margin-top: 10px;">Click the link to "Set Your Password" or Copy and Paste below URL into your web browser: <a href="{{ $setPasswordUrl ?? '#' }}">{{ $setPasswordUrl ?? '' }}</a></p>
