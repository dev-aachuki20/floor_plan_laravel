                ...
                <div class="card-body pt-0">
                    <div class="rootwizard">
                        <ul class="nav nav-pills nav-justified form-wizard-header mb-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link rounded-0 py-2 navTab disabled" href="{{ route('admin.companies.stepForm',2) }}" data-step="2" data-tab-type="step2Section">
                                    <i class="ri-profile-line fw-normal fs-20 align-middle me-1"></i>
                                    <span class="d-none d-sm-inline">Overview</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded-0 py-2 navTab disabled" href="{{ route('admin.companies.stepForm',3) }}" data-step="3" data-tab-type="step3Section">
                                    <i class="ri-map-pin-fill fw-normal fs-20 align-middle me-1"></i>
                                    <span class="d-none d-sm-inline">Location</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded-0 py-2 navTab disabled" href="{{ route('admin.companies.stepForm',4) }}" data-step="4" data-tab-type="step4Section">
                                    <i class="ri-profile-line fw-normal fs-20 align-middle me-1"></i>
                                    <span class="d-none d-sm-inline">Project Information</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded-0 py-2 navTab disabled" href="{{ route('admin.companies.stepForm',5) }}" data-step="5" data-tab-type="step5Section">
                                    <i class="ri-profile-line fw-normal fs-20 align-middle me-1"></i>
                                    <span class="d-none d-sm-inline">Serivces & Industries</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded-0 py-2 navTab disabled" href="{{ route('admin.companies.stepForm',6) }}" data-step="6" data-tab-type="step6Section">
                                    <i class="ri-profile-line fw-normal fs-20 align-middle me-1"></i>
                                    <span class="d-none d-sm-inline">Portfolio</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded-0 py-2 navTab disabled" href="{{ route('admin.companies.stepForm',7) }}" data-step="7" data-tab-type="step7Section">
                                    <i class="ri-profile-line fw-normal fs-20 align-middle me-1"></i>
                                    <span class="d-none d-sm-inline">Clients</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link rounded-0 py-2 navTab disabled" href="{{ route('admin.companies.stepForm',8) }}" data-step="8" data-tab-type="step8Section">
                                    <i class="ri-profile-line fw-normal fs-20 align-middle me-1"></i>
